...
<?php global $post; $picture = wp_get_attachment_url( get_post_thumbnail_id(117) );?>
...
<div class="rubrique">
    <div class="section-1 d-none d-lg-block" style="background-image: url(<?php echo $picture;?>);">
        <div class="container">
            <div class="blc">
                <h1>Assistance Comptes & moyens de paiement </h1>
            </div>
        </div>  
    </div>
    ...
    <div class="section-1-mobile d-block d-lg-none">
        ...
        <div class="container">
            <div class="blc">
                <h1>Assistance <br>Comptes & moyens de paiement </h1>
            </div>
        </div>  
    </div>
                ...
                <div class="col-lg-9">
                    <div class="file-ariane d-none d-lg-block">
                        <ul>
                            ...
                            <li><a href="<?php echo esc_url(home_url( '/' ) ); ?>/clients/comptes-moyens-de-paiements"><?php $rubrique = get_the_category(); echo $rubrique[1]->cat_name; ?> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon-right.png" class="img-fluid"/></a></li>
