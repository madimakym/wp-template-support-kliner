                ...
                <div class="col-lg-9">
                    <div class="file-ariane d-none d-lg-block">
                        <ul>
                            ...
                            <li><a href="<?php echo esc_url(home_url( '/' ) ); ?>/clients/services-tarifs"><?php $rubrique = get_the_category(); echo $rubrique[2]->cat_name; ?> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon-right.png" class="img-fluid"/></a></li>
