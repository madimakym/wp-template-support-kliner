                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                     <?php the_field('commander_une_prestation'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default in">
                            ...
                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <?php the_field('gerer_une_prestation_commandee'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default in">
                            ...
                            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <?php the_field('execution_des_prestations'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default in" style="border-bottom: 1px solid #00000012;">
                            ...
                            <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <?php the_field('apres_une_prestation'); ?>
                                </div>
                            </div>
                        </div>
