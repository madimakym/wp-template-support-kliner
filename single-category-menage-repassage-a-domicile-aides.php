...
<?php
        global $post; $picture = wp_get_attachment_url( get_post_thumbnail_id(120) );
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 menu-sidebar d-none d-lg-block">
                    <ul>
                        <li><a href="<?php echo esc_url(home_url( '/' ) ); ?>/aides-menageres/services-tarifs" class="active">SEVICES & TARIFS</a></li>
                ...
                <div class="col-lg-9">
                    <div class="file-ariane d-none d-lg-block">
                        <ul>
                            ...
                            <li><a href="<?php echo esc_url(home_url( '/' ) ); ?>/aides-menageres/services-tarifs">Services & Tarifs <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon-right.png" class="img-fluid"/></a></li>
                            <li><a><?php $sous_rubrique = get_the_category(); echo $sous_rubrique[0]->cat_name; ?><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon-right.png" class="img-fluid"/></a></li>
                        </ul> 
                    </div>
                
                    <!-- file ariane mobile -->
                    <div class="file-ariane-mobile d-block d-md-none">
                       <a href="<?php echo esc_url(home_url( '/aides-menageres/services-tarifs/' ) ); ?>"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons8-left.png" class="img-fluid"/><?php $sous_rubrique = get_the_category(); echo $sous_rubrique[0]->cat_name; ?></a>
                    </div>
