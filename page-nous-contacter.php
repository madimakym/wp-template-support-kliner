...
<?php
    // clients
    $nous_contacter_clients = new WP_Query(array(
        'category_name'			=> 'nous-contacter-clients',
    ));

    // aides menageres
    $nous_contacter_aides = new WP_Query(array(
        'category_name'			=> 'nous-contacter-aides',
    ));
?>
...
<div class="rubrique">
    <div class="section-1 d-none d-lg-block" style="background-image: url(<?php echo $picture['0'];?>);">
        <div class="container">
            <div class="blc">
                <h1>Assistance Nous contacter</h1>
            </div>
        </div>  
    </div>
    ...
    <div class="section-1-mobile d-block d-lg-none">
        ...
        <div class="container">
            <div class="blc">
                <h1>Assistance <br>Nous contacter</h1>
            </div>
        </div>  
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 menu-sidebar d-none d-lg-block">
                    <?php if( is_page('Nous contacter (Aides menagères)')): ?>
                        <ul>
                            ...
                            <li><a href="<?php echo esc_url(home_url( '/' ) ); ?>/aides-menageres/nous-contacter" class="active">NOUS CONTACTER</a></li>
                        </ul>
                    <?php else: ?>
                        <ul>
                            ...
                            <li><a href="<?php echo esc_url(home_url( '/' ) ); ?>/clients/nous-contacter"  class="active">NOUS CONTACTER</a></li>
                        </ul>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="panel-body">
                        <?php if( is_page('Nous contacter (Aides menagères)')): ?>
                            <?php while ($nous_contacter_aides -> have_posts()) : $nous_contacter_aides -> the_post(); ?>
                                <p><a href="<?php the_permalink() ?>"> <?php the_title(); ?></a></p>
                                <?php endwhile; ?>
                            <?php else: ?>
                            <?php while ($nous_contacter_clients -> have_posts()) : $nous_contacter_clients -> the_post(); ?>
                                <p><a href="<?php the_permalink() ?>"> <?php the_title(); ?></a></p>
                                <?php endwhile; ?>
                        <?php endif; ?>
                    </div>
