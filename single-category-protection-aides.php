                ...
                <div class="col-lg-9">
                    <div class="file-ariane d-none d-lg-block">
                        <ul>
                            ...
                            <li><a href="<?php echo esc_url(home_url( '/' ) ); ?>/aides-menageres/protection"><?php $rubrique = get_the_category(); echo $rubrique[2]->cat_name; ?> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon-right.png" class="img-fluid"/></a></li>
                            <li><a href="#"><?php $sous_rubrique = get_the_category(); echo $sous_rubrique[0]->cat_name; ?><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon-right.png" class="img-fluid"/></a></li>
                        </ul> 
                    </div>
