                ...
                <div class="col-lg-9">
                    <div class="file-ariane d-none d-lg-block">
                        <ul>
                            ...
                            <li><a><?php $sous_rubrique = get_the_category(); echo $sous_rubrique[1]->cat_name; ?><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon-right.png" class="img-fluid"/></a></li>
                        </ul> 
                    </div>
                
                    <!-- file ariane mobile -->
                    <div class="file-ariane-mobile d-block d-md-none">
                       <a href="<?php echo esc_url(home_url( '/aides-menageres/services-tarifs/' ) ); ?>"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons8-left.png" class="img-fluid"/><?php $sous_rubrique = get_the_category(); echo $sous_rubrique[1]->cat_name; ?></a>
                    </div>
